    ...
    <div className="my-32 mx-10">
      <div>
        ...
        <p className="text-gray-700 pt-3 pb-5">
          ...
          understanding of subjects, preparing students for higher education and
          beyond.
        </p>
        <h3 className="text-2xl text-gray-700 font-semibold">
        ...
        <ul className="pb-5">
          ...
          <li>
            ...
            the life of the Prophet Muhammad (Peace and blessings be upon them)
            and significant events in Islamic history.
          </li>
          <li>
