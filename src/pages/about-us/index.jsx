  ...
  return (
    <div className="my-32 mx-10">
      ...
      <p className="text-gray-700 pt-3 pb-5">
        At Al-Madinah Online School, We Are Dedicated To Providing An Education
        That Fosters Academic Excellence And Personal Growth. Our Curriculum Is
        Designed To Challenge And Inspire Students, Preparing Them For Future
        Success While Instilling Strong Islamic Values.
      </p>
      ...
      <p className="text-gray-700 pt-3 pb-5">
        ...
        comprehensive approach to education. The Cambridge curriculum emphasizes
        critical thinking, problem-solving, and a deep understanding of
        subjects, preparing students for higher education and beyond.
      </p>
      <h3 className="text-2xl text-gray-700 font-semibold">
        Key Stage 3 Subjects
      </h3>
      <p className="text-gray-700 pt-3">
        In Years 7 to 9, our students engage in a broad range of subjects that
        form the foundation of their secondary education. These subjects
        include:
      </p>
      <ul className="pb-5">
        <li>
        ...
        <li>
          <span className="font-semibold ">Mathematics</span> Our mathematics
          program focuses on developing strong numeracy skills, logical
        ...
        <li>
          <span className="font-semibold ">History </span> Students learn about
          significant historical events and figures, developing an understanding
        ...
        <li>
          <span className="font-semibold ">Modern Foreign Languages </span> We
          offer Arabic, providing students with the opportunity to become
          proficient in additional languages.
        </li>
        <li>
          <span className="font-semibold ">IT </span> Students acquire essential
          skills in coding, programming, and digital literacy.
        </li>
        <li>
          <span className="font-semibold ">Physical Education </span> Regular
          physical activity promotes health and well-being, with a focus on
          teamwork.
        </li>
      </ul>
      <h3 className="text-2xl text-gray-700 font-semibold">
      ...
      <p className="text-gray-700 pt-3">
        ...
        students receive a balanced education that nurtures their spiritual and
        moral development. Key Islamic subjects include:
      </p>
      <ul className="pb-5">
        <li>
        ...
        <li>
          <span className="font-semibold ">Islamic History</span>Lessons on the
          life of the Prophet Muhammad (Peace and blessings be upon them) and
        ...
        <li>
          <span className="font-semibold ">Arabic Language </span>Emphasis on
          proficiency in Arabic to enhance Quranic understanding and
          communication.
        </li>
        <li>
          <span className="font-semibold ">Modern Foreign Languages </span> We
      ...
      <p className="text-gray-700 pt-3">
        Our teaching methods are designed to engage students actively in their
        learning journey. We employ a variety of instructional strategies,
        including:
      </p>
      <ul className="pb-5">
        <li>
        ...
        <li>
          <span className="font-semibold ">Continuous Feedback </span> Regular
          assessments and feedback to support student growth and improvement.
        </li>
      </ul>
      <h3 className="text-2xl text-gray-700 font-semibold">
      ...
      <p className="text-gray-700 pt-3">
        We use a comprehensive assessment system to evaluate student progress
        and achievement. This includes:
      </p>
      <ul className="pb-5">
        <li>
          <span className="font-semibold ">Examinations</span> Formal exams to
          assess understanding and knowledge retention.
        </li>
        <li>
          <span className="font-semibold ">Coursework </span>
          Assignments and projects that allow students to apply their learning
          in practical ways.
        </li>
        <li>
          <span className="font-semibold ">Formative Assessments </span> Regular
          quizzes and class activities to monitor ongoing progress.
        </li>
      </ul>
      <h3 className="text-2xl text-gray-700 font-semibold">
      ...
      <p className="text-gray-700 pt-3">
        Beyond the classroom, we offer a variety of extracurricular activities
        that complement our academic program. These activities provide
        opportunities for students to explore their interests and develop new
        skills:
      </p>
      <ul className="pb-5">
        <li>
          <span className="font-semibold ">Clubs and Societies</span> Science
          Club, Debate Team, Art Club, Quran Recitation Group.
        </li>
        <li>
