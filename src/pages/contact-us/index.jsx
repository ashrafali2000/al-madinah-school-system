      ...
      <div>
        ...
        <div className="mt-12 bg-white  grid grid-cols-2 gap-5 p-6 border-4 border-gray-700 rounded-[40px]">
          <div className="mt-4 flex flex-col justify-center gap-4 lg:gap-8">
            <p className="text-gray-900 pt-3 font-bold text-xl">
              Have a question or need more information? Please fill out the form
              ,and we will get back to you as soon as possible.
            </p>
            <div className="flex ">
              <motion.h3
                className="cursor-pointer text-2xl  w-auto py-2 px-3 inline-block rounded-lg  bg-[rgb(250,204,20)] text-black font-semibold "
                initial={{ opacity: 0, scale: 0.2 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{
                  duration: 20, // removed quotes around the duration
