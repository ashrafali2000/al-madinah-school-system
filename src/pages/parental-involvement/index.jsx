      ...
      <div className="bg-white   place-items-center rounded-[40px] max-w-7xl h-[550px] border-4 border-gray-700 ">
        <div className="grid grid-cols-1   mx-auto  lg:grid-cols-2  px-10 gap-10 mt-20">
          <AnimatedComponentLeft>
            <div>
              <img className=" rounded-xl" src="/comunity.jpg" alt="image" />
            </div>
          </AnimatedComponentLeft>
          <AnimatedComponentRight>
            <div className="flex flex-col gap-4">
              ...
              <p className="text-lg mt-5 text-gray-700 font-bold">
                ...
                parents. Parents are encouraged to participate in the volunteer
                for school events, and stay engaged through regular
                communication channels such as newsletters, parent-teacher
                meetings, and our online portal.
              </p>
            </div>
          </AnimatedComponentRight>
        </div>
